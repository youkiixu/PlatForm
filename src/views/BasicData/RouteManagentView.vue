...
<template>
    <div @keyup.enter="getData()">
        ...
        <Card>
            ...
            <!-- <Row>
                <span style="margin: 0 10px;">
                    <Button type="success" icon="android-add" @click="addProduct(0)">添加路线</Button>
                </span>
                <span style="margin: 0 10px;">
                    <Button type="warning" icon="wrench" @click="addProduct(1)">修改</Button>
                </span>
                <span style="margin: 0 10px;">
                    <Button type="info" icon="android-add" @click="addProduct(2)">设置仓库路线</Button>
                </span>
                <span style="margin: 0 10px;">
                    <Button type="ghost" icon="android-add" @click="addProduct(3)">分配大车司机</Button>
                </span>
            </Row> -->
            <Row class="margin-top-10">
                <Col span="8">
                线路名称:
                <Input v-model="form.$key" placeholder="请输入线路名称..." style="width: 150px" />
                </Col>
            </Row>
            <Row class="margin-top-10">
        ...
        <addRouteManagentComponent ref="showEdit" :param="selectRowData" @onSuccess="getData()"></addRouteManagentComponent>
    </div>
</template>
<!-- 第三方公司管理 -->
<script>
    ...
    import addRouteManagentComponent from './components/addRouteManagent-component'

    export default {
        name: 'RouteManagentView',
        components: {
            datePickerCompoent,
            addRouteManagentComponent,
