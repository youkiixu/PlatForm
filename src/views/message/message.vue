    ...
    methods: {
        ...
        getContent (index) {
            ...
            switch (this.currentMessageType + index) {
                case 'unread0': mesContent = '暂未开放消息中心。'; break;
                case 'unread1': mesContent = '暂未开放消息中心。'; break;
                case 'unread2': mesContent = '暂未开放消息中心。'; break;
                case 'hasread0': mesContent = '暂未开放消息中心。'; break;
                default: mesContent = '暂未开放消息中心。'; break;
            }
