...
<template>
    <div class="login" @keydown.enter="handleSubmit">
        <canvas id="canvas" v-if="backgroundDom"></canvas>
        ...
        <div class="login-con">
            ...
            <Card :bordered="true">
                <p slot="title" @click="showQRCode">
                    <Icon type="log-in"></Icon>
                    <span v-if="showQR">密码登录</span>
                    <span v-if="!showQR">扫码登录</span>
                </p>
                <div class="form-con" v-if="showQR">
                    <img :src="qr" style="display:block;margin:0 auto;width:200px;height:200px;" alt="">
                </div>
                <div class="form-con"  v-if="!showQR">
                    <Form ref="loginForm" :model="form" :rules="rules">
                        ...
                        <FormItem prop="password">
                            <Input type="password" v-model="form.password" class="psw-focus" placeholder="请输入密码">
                                <span slot="prepend">
                                    <Icon :size="14" type="locked"></Icon>
                                </span>
                            </Input>
                        </FormItem>
                        <FormItem prop="password" v-if="isCheck">
                            <Input v-model="form.checkCode" placeholder="请输入验证码">
                                <span slot="prepend">
                                    <Icon :size="14" type="ios-loop-strong"></Icon>
                                </span>
                            </Input>
                        </FormItem>
                        <FormItem prop="checkCodeImg"  v-if="isCheck">
